...
const MainLayout = () => {
    ...
    return (
        <div className={`flex flex-col min-h-screen transition-colors duration-300 ${
            theme === 'dark' ? 'bg-gray-950 text-white' : 'bg-gray-50 text-gray-950'
        }`}>
            ...
            <footer className={`border-t p-6 text-center text-sm transition-colors ${
                theme === 'dark' ? 'bg-gray-900 border-gray-800 text-gray-400' : 'bg-white border-gray-200 text-gray-500'
            }`}>
